...
class JobboleSpider(scrapy.Spider):
    ...
    def parse_detail(self, response):
        ...
        # create_time=response.xpath('//*[@id="post-110287"]/div[2]/p/text()').extract()[0].strip().replace("·","").strip()
        # praise_times=response.xpath('//*[@id="post-110287"]/div[3]/div[9]/span[1]/h10/text()').extract()[0]
        ...
        #
        # # css选择器
        # title=response.css('#post-110287 > div.entry-header > h1::text').extract()[0]
        # create_time=response.css('#post-110287 > div.entry-meta > p::text').extract()[0].strip().replace('·','').strip()
        pass
